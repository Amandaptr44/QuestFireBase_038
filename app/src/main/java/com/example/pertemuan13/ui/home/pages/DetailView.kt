...
import com.example.pt10.ui.viewmodel.DetailUiState
import com.example.pt10.ui.viewmodel.DetailViewModel
...
fun ItemDetailMhs(
    ...
    Card (
        ...
        Column (
            ...
            ComponentDetailMhs(judul = "Judul Skripsi", isinya = mahasiswa.judulp)
            Spacer(modifier = Modifier.padding(4.dp))

            ComponentDetailMhs(judul = "Dosen Pembimbing", isinya = mahasiswa.dosen)
            Spacer(modifier = Modifier.padding(4.dp))
        }
    }
}
